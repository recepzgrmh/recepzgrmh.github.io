...
Üçüncü madde durdurma mekanizması. Bir AI aracı beklenmedik bir repo taraması yapıyorsa ya da olağandışı sayıda dış bağlantı kuruyorsa ekip bunu fark edip erişimi askıya alabilmeli. Cisco’nun rehberinde savunma tarafı için loglama, tehdit avcılığı ve aldatma teknikleri gibi yaklaşımlar öne çıkıyor. Bir AI ajanını yakalamak için honeypot kullanma fikri özellikle dikkat çekici, fakat bunun nasıl uygulanacağı konusunda genel önerilerin ürün ekiplerine doğrudan reçete sunduğundan emin değilim. ([cisco.com](https://www.cisco.com/site/us/en/solutions/artificial-intelligence/cisco-defending-against-ai-attacks-guidance.html))
