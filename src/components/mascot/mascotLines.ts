...
const EN: LineBook = {
  ...
  hover: {
    ...
    dancem: { text: "Dance at your webcam, it writes the track. No, really.", pose: "point" },
  ...
  page: {
    ...
    "project:dancem": { text: "33 joints, 30 times a second. Then it makes music.", pose: "point" },
...
const TR: LineBook = {
  ...
  hover: {
    ...
    dancem: { text: "Kameraya dans et, parçayı kendi yazıyor. Cidden.", pose: "point" },
  ...
  page: {
    ...
    "project:dancem": { text: "33 eklem, saniyede 30 kez. Sonrası müzik.", pose: "point" },
