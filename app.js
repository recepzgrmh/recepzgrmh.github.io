...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        tr: {
            ...
            'projects.tubitak.desc': 'TÜBİTAK destekli yurt bulma MVP\'si. İzmir\'deki tüm yurt verileri 2 ay boyunca sahada tek tek toplanarak Firebase\'e işlendi. Ardından React Native, Haversine ve ağırlıklı puanlama algoritmalarıyla akıllı bir öneri motoru inşa edildi.',
        ...
        en: {
            ...
            'projects.tubitak.desc': 'TÜBİTAK-supported dorm search MVP. All dorm data in Izmir was collected manually in the field over 2 months and integrated into Firebase. A smart recommendation engine was then built using React Native, Haversine, and weighted scoring algorithms.',
