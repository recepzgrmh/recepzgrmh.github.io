window.translations = {
    tr: {
        ...
        'hero.available': 'Yeni Fırsat Değerlendiriyorum',
        'hero.subtitle': 'Mobil Geliştirici & Ürün Odaklı Mühendis',
        'hero.name': 'RECEP<br>OZGUR.',
        'hero.desc': 'Flutter, Firebase ve GCP ile iOS, Android ve web\'de 5.000+ indirme ve 150K+ App Store impression\'a ulaşan ürünler geliştirdim. <span class="text-white font-medium">AI-augmented iş akışları ve ölçeklenebilir mimari</span> odağıyla uçtan uca ürün sahipliği alıyorum.',
        ...
        'vision.p4.desc': 'Ölçeklenebilir mimariler kuran, yüksek mühendislik standartlarına sahip ekiplerde katma değer üretmek istiyorum.',
        ...
        'bento.work.desc': 'Tek mobil geliştirici olarak Sano AI\'ı uçtan uca (Flutter/Firebase/GCP) canlıya aldım. 3.000+ Google Play, 2.000+ App Store indirme, 150K+ impression, 4.7/5 puan ve %99.9+ crash-free.',
        'bento.work.duration': 'Oca 2025 — Halen',
        ...
        'projects.sano.feat3': 'Firebase Crashlytics ile <strong>%99.9+ crash-free</strong> oranını ve <strong>4.7/5</strong> puanını yakalayarak 3.000+ Google Play, 2.000+ App Store indirme ve 150K+ App Store gösterimine ulaştım.',
    ...
    en: {
        ...
        'hero.name': 'RECEP<br>OZGUR.',
        'hero.desc': 'I\'ve shipped Flutter apps on iOS, Android and web reaching 5,000+ downloads and 150K+ App Store impressions. I take end-to-end product ownership with <span class="text-white font-medium">AI-augmented workflows and scalable architecture.</span>',
        ...
        'vision.p4.desc': 'I want to create value in teams with high engineering standards who build scalable architectures.',
        ...
        'bento.work.role': 'Mobile Software Developer',
        'bento.work.desc': 'Shipped Sano AI end-to-end as sole mobile dev (Flutter/Firebase/GCP). 3,000+ Google Play, 2,000+ App Store downloads, 150K+ impressions, 4.7/5 rating, 99.9%+ crash-free.',
        'bento.work.duration': 'Jan 2025 — Present',
        ...
        'projects.sano.feat3': 'Achieved <strong>99.9%+ crash-free</strong> rate and <strong>4.7/5</strong> rating with Firebase Crashlytics, reaching 3,000+ Google Play, 2,000+ App Store downloads and 150K+ impressions.',
