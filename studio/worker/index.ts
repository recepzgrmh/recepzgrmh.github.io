...
- visualPrompt İngilizce ve 16:9 olmalı. ESTETİKTEN ÖNCE KONU TANINIRLIĞI: başlık gizlendiğinde bile izleyici görselin hangi ürünleri, teknolojileri veya problemi anlattığını iki saniyede söyleyebilmeli. Başlıktaki özel isimleri ve ana konuyu görselden çıkarıp jenerik metaforla değiştirme.
- Önce yazıyı görsel türüne ayır: (1) ürün/model karşılaştırması, (2) benchmark/veri analizi, (3) teknik mimari, (4) rehber veya (5) soyut fikir. Metafor yalnız soyut fikirlerde veya doğrudan gösterilecek tanınabilir bir konu yoksa kullanılsın.
- Ürün/model karşılaştırmasında karşılaştırılan gerçek ürünleri kompozisyonun ana öznesi yap. Resmi marka kimliklerini, doğru model adlarını ve gerektiğinde doğru logoları editoryal bağlamda kullanabilirsin. İki tarafı belirgin bir split-screen, karşılaştırma kartı veya benchmark panosu ile göster; telefon, sunucu, terazi, el, ampul gibi jenerik ikameler kullanma.
- Benchmark yazısında gerçek sayı verilmemişse puan uydurma ve sahte kazanan ilan etme. Bunun yerine kategorileri, göreli çubukları veya ölçüm fikrini açık ama tarafsız bir editoryal düzenle göster. Kod kalitesi, maliyet ve otonomi gibi yazının gerçekten ele aldığı boyutlar görselde seçilebilmeli.
- Teknik mimari yazısında yalnızca ana akışı sadeleştir; bütün alt başlıkları ve her olayı tek kareye doldurma. Tek odak noktası, en fazla 3 ana görsel grup, güçlü siluet ve temiz negatif alan kullan.
- Sanat yönünü konuya göre seç: marka karşılaştırmalarında parlak, insan eli değmiş premium dergi grafiği veya screen-print kolaj; fiziksel konularda doğal ışıklı editoryal fotoğraf; mimaride sade ve anlaşılır diyagram. Her yazıya otomatik olarak krem masa, notebook, telefon veya mixed-media kolaj verme.
...
- Marka karşılaştırması dışında okunabilir yazı ve logo kullanma. Marka karşılaştırmasında yalnızca yazının konusu olan resmi ürün/model adlarına ve doğru logolara izin ver; dekoratif sahte metin, uydurma marka, kod veya UI screenshot ekleme. Promptta kompozisyonu, görsel hiyerarşiyi ve sanat yönünü net tarif et; negatif prompt kısmında alakasız jenerik metaforları da dışla.
