---
title: "Junior Yazılımcılık Koddan Karara Doğru Nasıl Değişecek?"
...
draft: false
sources:
  - label: "The Impact of AI Coding Assistants on Software Engineering: A Longitudinal Study"
    url: "https://arxiv.org/abs/2605.23135"
    note: "2026 tarihli uzun dönemli araştırma; kod yazmaya ayrılan sürenin azalması ve doğrulama-yönlendirme işlerinin artması üzerine."
  - label: "Code with Me or for Me? How Increasing AI Automation Transforms Developer Workflows"
    url: "https://arxiv.org/abs/2507.08149"
    note: "Kodlama ajanlarının daha otonom görevlerdeki etkisini ve geliştiricinin ajan davranışını anlaması gereğini inceliyor."
  - label: "Junior Software Developers' Perspectives on Adopting LLMs for Software Engineering: a Systematic Literature Review"
    url: "https://arxiv.org/abs/2503.07556"
    note: "Junior geliştiricilerin AI kullanımındaki fayda, risk ve öğrenme deneyimlerini 56 çalışmanın taramasıyla özetliyor."
  - label: "Developers remain willing but reluctant to use AI: the 2025 Developer Survey results are here"
    ...
    note: "AI kullanımının yaygınlaştığını, güvenin ise aynı ölçüde artmadığını gösteren geliştirici anketi sonuçları."
  - label: "Frontier Risk Report, February to March 2026"
    url: "https://metr.org/risk-report-feb-mar-2026.pdf"
    note: "AI destekli yazılım geliştirme deneyleri ve üretkenlik etkileri hakkında güncel değerlendirme."
---
